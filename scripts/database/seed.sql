...
INSERT INTO public.asset_classes (
    ...
    (NULL, 'server', 'computer', 'hardware.computer.server',
     ...
     '{"type":"object","additionalProperties":false,"properties":{"vendor":{"type":"string","description":"Manufacturer or brand as reported by the device."},"model":{"type":"string","description":"Manufacturer model designation."},"asset_tag":{"type":"string","description":"Organisation''s own inventory tag, if one is affixed."},"operating_system":{"type":"string","description":"OS product name, e.g. \"Ubuntu\", \"Windows Server\"."},"os_version":{"type":"string","description":"OS version string as reported."},"architecture":{"type":"string","description":"CPU architecture, e.g. amd64, arm64."},"cpu_count":{"type":"integer","description":"Logical CPU count."},"memory_mb":{"type":"integer","description":"Installed memory in mebibytes."},"server_role":{"type":"string","description":"Primary role the server plays, e.g. web, database, file, domain controller. Free text; the relationship graph is authoritative."}}}'::jsonb, ARRAY['agent_id', 'sensor_id', 'serial_number', 'cmdb_sys_id', 'ssh_host_key_fingerprint', 'mac_address', 'fqdn', 'hostname', 'ip_address']::text[],
    ...
    (NULL, 'workstation', 'computer', 'hardware.computer.workstation',
     ...
     '{"type":"object","additionalProperties":false,"properties":{"vendor":{"type":"string","description":"Manufacturer or brand as reported by the device."},"model":{"type":"string","description":"Manufacturer model designation."},"asset_tag":{"type":"string","description":"Organisation''s own inventory tag, if one is affixed."},"operating_system":{"type":"string","description":"OS product name, e.g. \"Ubuntu\", \"Windows Server\"."},"os_version":{"type":"string","description":"OS version string as reported."},"architecture":{"type":"string","description":"CPU architecture, e.g. amd64, arm64."},"cpu_count":{"type":"integer","description":"Logical CPU count."},"memory_mb":{"type":"integer","description":"Installed memory in mebibytes."},"assigned_user":{"type":"string","description":"Primary user, by email or directory name."}}}'::jsonb, ARRAY['agent_id', 'sensor_id', 'serial_number', 'cmdb_sys_id', 'mac_address', 'fqdn', 'hostname']::text[],
    ...
    (NULL, 'mobile', 'computer', 'hardware.computer.mobile',
     ...
     '{"type":"object","additionalProperties":false,"properties":{"vendor":{"type":"string","description":"Manufacturer or brand as reported by the device."},"model":{"type":"string","description":"Manufacturer model designation."},"asset_tag":{"type":"string","description":"Organisation''s own inventory tag, if one is affixed."},"operating_system":{"type":"string","description":"OS product name, e.g. \"Ubuntu\", \"Windows Server\"."},"os_version":{"type":"string","description":"OS version string as reported."},"architecture":{"type":"string","description":"CPU architecture, e.g. amd64, arm64."},"cpu_count":{"type":"integer","description":"Logical CPU count."},"memory_mb":{"type":"integer","description":"Installed memory in mebibytes."},"platform":{"type":"string","enum":["ios","android","other"],"description":"Mobile platform family."},"mdm_enrolled":{"type":"boolean","description":"Whether the device is enrolled in mobile device management."}}}'::jsonb, ARRAY['agent_id', 'sensor_id', 'serial_number', 'cmdb_sys_id', 'mac_address', 'hostname']::text[],
     NULL, 'device', true),
    ...
    (NULL, 'virtual', NULL, 'virtual',
     ...
     '{"type":"object","additionalProperties":false,"properties":{"cpu_count":{"type":"integer","description":"Allocated virtual CPUs."},"memory_mb":{"type":"integer","description":"Allocated memory in mebibytes."}}}'::jsonb, ARRAY['agent_id', 'sensor_id', 'cloud_resource_id', 'cmdb_sys_id', 'ssh_host_key_fingerprint', 'mac_address', 'fqdn', 'hostname', 'ip_address']::text[],
     NULL, 'platform', true),
    (NULL, 'virtual_machine', 'virtual', 'virtual.virtual_machine',
     'Virtual machine', 'A guest machine running on a hypervisor.', 'Box',
     '{"type":"object","additionalProperties":false,"properties":{"cpu_count":{"type":"integer","description":"Allocated virtual CPUs."},"memory_mb":{"type":"integer","description":"Allocated memory in mebibytes."},"operating_system":{"type":"string","description":"Guest OS product name."},"os_version":{"type":"string","description":"Guest OS version string."},"guest_tools_version":{"type":"string","description":"Hypervisor guest-tools version, if installed."}}}'::jsonb, ARRAY['agent_id', 'sensor_id', 'cloud_resource_id', 'cmdb_sys_id', 'ssh_host_key_fingerprint', 'mac_address', 'fqdn', 'hostname', 'ip_address']::text[],
    ...
    (NULL, 'unknown_host', NULL, 'unknown_host',
     ...
     '{"type":"object","additionalProperties":false,"properties":{}}'::jsonb, ARRAY['serial_number', 'agent_id', 'sensor_id', 'ssh_host_key_fingerprint', 'mac_address', 'fqdn', 'hostname', 'ip_address']::text[],
     NULL, 'device', true)
...
INSERT INTO public.classification_rules (
    ...
    ('model', 'PowerEdge', 'server', 'Dell', NULL, 0.85, 'https://www.dell.com/en-us/shop/servers-storage-and-networking/poweredge-r650-rack-server/spd/poweredge-r650'),
    ('model', 'ProLiant', 'server', 'Hewlett Packard', NULL, 0.85, 'https://buy.hpe.com/us/en/compute/rack-servers/proliant-dl300-servers/hpe-proliant-dl360-gen10-server/p/1010007891'),
    ...
    ('mdns_service', '_matter._tcp', 'iot_device', NULL, NULL, 0.75, 'https://csa-iot.org/all-solutions/matter/'),
