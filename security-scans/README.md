...
- **Generated**: 2026-09-14T10:13:53Z
...
## 0 CRITICAL · 6 HIGH (fixable, across 17 scanned images)
...
| `web-ui` | 0 | 3 |
| `admin-service` | ❌ not scanned | ❌ not scanned |
...
- `ghcr.io/vistasecurity/admin-service:latest`
...
<sub>Produced by [this workflow run](https://github.com/bob-vistasecurity/VistaPlatform/actions/runs/34831987394).</sub>
