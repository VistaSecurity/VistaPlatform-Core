...
func main() {
	...
	if *version {
		fmt.Printf("Vista Platform Network Sensor v%s\n", Version)
	...
	log.Printf("🚀 Starting Vista Platform Network Sensor v%s", Version)
...
func runInteractiveMode(caFingerprint string, verbose bool) {
	fmt.Println("🔧 Vista Platform Network Sensor - Interactive Configuration")
	fmt.Println("=============================================================")
	fmt.Println()
...
func createConfigFile(configPath, controlPlaneURL, registrationKey string, interval int, dataPath string, interfaces []string, serverCACertPath string) error {
	...
	// Add header comment
	fmt.Fprintf(&configContent, "# Vista Platform Network Sensor Configuration\n# Generated by interactive configuration on %s\n\n", time.Now().Format("2006-01-02 15:04:05"))
