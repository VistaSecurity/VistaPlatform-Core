...
Test mTLS configuration across all services:
...
This verifies:
- Certificate files exist for all services
- Certificates are valid and not expired
- Health endpoints work on HTTP (port 8080)
- API endpoints work on HTTPS with mTLS (port 8443)
- Services reject connections without valid certificates
...
- **mTLS Test Script**: `./scripts/test-mtls.sh` or `make test-mtls`
